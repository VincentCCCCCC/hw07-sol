...
The deadline for Homework 7 is Monday, November 8, 4pm. The late submission deadline is Monday, November 15, 4pm.
...
available at
`https://github.com/nyu-popl-fa21/hw07-<YOUR-GITHUB-USERNAME>`.
Note that this may take a few minutes.

* Open a browser at `https://github.com/nyu-popl-fa21/hw07-<YOUR-GITHUB-USERNAME>` with your Github username inserted at the appropriate place in the URL.
* Choose a place on your computer for your homework assignments to reside and open a terminal to that location.
* Execute the following git command: <br/>
  ```bash
  git clone https://github.com/nyu-popl-fa21/hw07-<YOUR-GITHUB-USERNAME>.git hw07
  cd hw07
  ```
